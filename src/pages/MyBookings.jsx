...
const MyBookings = () => {
  ...
  return (
    <div className='py-28 md:pb-32 md:pt-32 px-4 md:px-16 lg:px-24 xl:px-32'>
        ...
        Plan your trip just a few clicks' align='left' />
            ...
            {bookings.map((booking)=>(
                <div key={booking._id} className='grid grid-cols-1 md:grid-cols-[3fr_2fr_1fr] w-full border-b border-gray-300 py-6 first:border-t'>
                    ...
                    <div className='flex flex-col md:flex-row gap-4'>
                        <img src={booking.room.images[0]} alt="hotel-img" className='w-full md:w-44 h-32 md:h-24 rounded shadow object-cover' />
